...
function App() {
  ...
  return (
    <div className="App">
      ...
      <a className="github-button" href="https://github.com/chenghaopeng/avalon" data-size="large" data-show-count="true" aria-label="Star chenghaopeng/avalon on GitHub">Star</a>
    </div>
  );
}
